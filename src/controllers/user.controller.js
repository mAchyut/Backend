...
//  console.log("Created user:userController :: ",createduser)
 if(!createduser){
...
const loginUser = asyncHandler(async (req, res)=>{
  ...
  if(!email && !username){
    throw new ApiError(400, "registered username or email is required")
  }
...
const getWatchHistory = asyncHandler(async(req, res)=>{
  ...
  .status(200)
  .json(
    new ApiResponse(200, user[0].watchHistory, "Watch history fetched successfylly")
  )
})
